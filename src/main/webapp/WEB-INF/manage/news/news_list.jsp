...
<!-- //   	$.ajax({ -->
<!-- //   		type:"POST", -->
<%-- //   		url:"${path}/new/newsa!func.action", --%>
<!-- //   		dataType : "json", -->
<!-- //   		success:function(meg){ -->
<!-- //   			for (var i = 0; i < meg.length; i++) { -->
<!-- //   				if(meg[i]==null&&meg[i]==21){ -->
<!-- //   					$("#bj").hiddle(); -->
<!-- //   				}else{ -->
<!-- //   					$("#bj").show(); -->
<!-- //   				} -->
<!-- // 				if(meg[i]==null&&meg[i]==22){ -->
<!-- // 					$("#delete").hiddle(); -->
<!-- //   				}else{ -->
<!-- //   					$("#delete").show(); -->
<!-- //   				} -->
...
<%--   	</script> --%>
 <body>
		...
		<div id="main" class="wrap">
			...
			<div class="main">
			<h2>
				新闻管理 <font color="red"> ${sessionScope.flag } <c:remove
							...
							<th>操作</th>
								...
								<c:forEach items="${list}" var="news"
									...
									<tr>
										...
										<td>${news.title }</td>
										<td class="qx"><a
											href="easybuy-web/manage/news/newsa!edit.action?id=${news.id}" id="bj">编辑</a>
